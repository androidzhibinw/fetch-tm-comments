...
urlbad='https://rate.tmall.com/list_detail_rate.htm?itemId=44320847678&spuId=327809007&sellerId=1732577545&order=1&append=0&content=1&tagId=620&posi=-1&picture=0'
...
def getPage(page_id):
    ...
    for item in myjson:
        if len(item['rateContent'].encode('utf-8')) >150:
            continue
        global index
        index += 1
        print index,' :'
